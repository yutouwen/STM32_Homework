...
void Timer_Init(void)
{
	...
	TIM_TimeBaseInitStructure.TIM_Period = 100 - 1;    /*ARR设定,取值范围0-65535，在10k频率下，记10k个数 1000*/
	TIM_TimeBaseInitStructure.TIM_Prescaler = 210 - 1;  /*PSC设定,取值范围0-65535，给72MHz分频，得到10k计数频率 7200*/
